...
# 126 "Peoyecto_SSE_13_05.c"
        }
    }

}
void acomodo(int input){
    int temp;
    if(input>=10 && input<=15){
    temp=(int)(input/10);
    habitaciones[0][temp]='F';
    }
    else if(input>=20 && input<=25){
        temp=(int)(input/20);
        habitaciones[1][temp]='F';
    }
    else if(input>=30 && input<=35){
        temp=(int)(input/30);
        habitaciones[2][temp]='F';
    }
}
