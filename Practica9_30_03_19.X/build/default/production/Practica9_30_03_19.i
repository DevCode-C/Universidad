...
void main(void) {
    ...
    ADCON0bits.ADON=1;
    float caracter;
    LATCbits.LC1=0;LATCbits.LC6=0;LATAbits.LA2=0;LATAbits.LA3=0;
    Lcd_Init();
    Lcd_Cmd(1);
    Lcd_Cmd(12);
    ...
    while(valor!= '*'){
        ...
        while(ADCON0bits.DONE){
            ...
            if(conver>max){
                LATCbits.LC1=1;LATAbits.LA2=1;
            }
            else if((conver<max) && (conver>min)){
                LATCbits.LC1=0;LATCbits.LC6=0;
                LATAbits.LA2=0;LATAbits.LA3=0;
            }
            else if(conver<min){
                LATCbits.LC6=1;LATAbits.LA3=1;
            }
        }
    }
    LATCbits.LC1=0;LATCbits.LC6=0;LATAbits.LA2=0;LATAbits.LA3=0;
