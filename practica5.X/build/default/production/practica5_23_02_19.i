...
_delay(10);
PORTDbits.RD5 = 1; _delay((unsigned long)((5)*(8000000/4000000.0))); PORTDbits.RD5 = 0;
...
void main(void) {
    ...
    for(i=10; i>0; i--)
    {
    sprintf(palabra,"Cuenta %03d",i);
    Lcd_Out2(1, 1, palabra);
