...
PORTDbits.RD5 = 0;
PORTDbits.RD4 = 0;
_delay((unsigned long)((5500)*(12000000/4000000.0)));
_delay((unsigned long)((5500)*(12000000/4000000.0)));
_delay((unsigned long)((5500)*(12000000/4000000.0)));
_delay((unsigned long)((5500)*(12000000/4000000.0)));
_delay((unsigned long)((5500)*(12000000/4000000.0)));
...
{
    PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 1; PORTDbits.RD5 = 0;
    PORTDbits.RD4 = 0; PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 1;
    PORTDbits.RD5 = 1; PORTDbits.RD4 = 0;
    _delay((unsigned long)((5)*(12000000/4000000.0)));
    PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 1; PORTDbits.RD5 = 0;
    PORTDbits.RD4 = 0;
    _delay((unsigned long)((5500)*(12000000/4000000.0)));
}
PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 0; PORTDbits.RD5 = 0; PORTDbits.RD4 = 0;
PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 0; PORTDbits.RD5 = 1; PORTDbits.RD4 = 0;
_delay((unsigned long)((5)*(12000000/4000000.0)));
PORTDbits.RD3 = 0; PORTDbits.RD2 = 0; PORTDbits.RD1 = 1; PORTDbits.RD0 = 0; PORTDbits.RD5 = 0; PORTDbits.RD4 = 0;
_delay((unsigned long)((5500)*(12000000/4000000.0)));
...
PORTDbits.RD3 = (data & 0b10000000)>>7; PORTDbits.RD2 = (data & 0b01000000)>>6;
PORTDbits.RD1 = (data & 0b00100000)>>5; PORTDbits.RD0 = (data & 0b00010000)>>4;
_delay(10);
PORTDbits.RD5 = 1; _delay((unsigned long)((5)*(12000000/4000000.0))); PORTDbits.RD5 = 0;
PORTDbits.RD3 = (data & 0b00001000)>>3; PORTDbits.RD2 = (data & 0b00000100)>>2;
PORTDbits.RD1 = (data & 0b00000010)>>1; PORTDbits.RD0 = (data & 0b00000001);
_delay(10);
PORTDbits.RD5 = 1; _delay((unsigned long)((5)*(12000000/4000000.0))); PORTDbits.RD5 = 0;
_delay((unsigned long)((5)*(12000000/4000000.0))); _delay((unsigned long)((5500)*(12000000/4000000.0)));
}


void Lcd_Cmd(unsigned char data){
PORTDbits.RD5 = 0; PORTDbits.RD4 = 0;
PORTDbits.RD3 = (data & 0b10000000)>>7; PORTDbits.RD2 = (data & 0b01000000)>>6;
PORTDbits.RD1 = (data & 0b00100000)>>5; PORTDbits.RD0 = (data & 0b00010000)>>4;
_delay(10);
PORTDbits.RD5 = 1; _delay((unsigned long)((5)*(12000000/4000000.0))); PORTDbits.RD5 = 0;
...
void UART_Init(long baud){
    TRISCbits.RC6=0;
    TRISCbits.RC7=1;
    SPBRG=(unsigned char)(((12000000/baud)/64)-1);
...
# 12 "Proyecto_SSE1_13_05.c" 2

static float P_Master=500.0,P_jacuzzi=450.0,P_normal=250.0;
unsigned char valor,datos,ptr_valor;
short int contador=0,count,r_nomal=0,r_jacuzzi=0,r_master=0;
unsigned long num_hab[3][6],fill_room;
unsigned char room_normal[6];
unsigned char room_jacuzzi[6];
unsigned char room_master[6];
unsigned char palabra[17],palabra1[17],palabra2[17],palabra3[17];
...
void envio_UART_Tx(char Tx, unsigned char informacion, int lugar );
void opciones(void);
...
void main(void) {
    ...
    while(1){
        if(PORTDbits.RD7==0 || PORTDbits.RD6==0){
            ...
            if((r_nomal==0)&&(r_jacuzzi==0)&&(r_master==0)){
                ...
                switch(fill_room){
                    case 'A':{
                        ...
                        _delay((unsigned long)((1500)*(12000000/4000.0)));
                        Lcd_Cmd(1);
                        _delay((unsigned long)((100)*(12000000/4000.0)));
                    ...
                    case 'B':{
                        ...
                        while(count!=100){
                            ...
                            LATCbits.LATC0=0;
                            _delay((unsigned long)((19)*(12000000/4000.0)));
                            count++;
                        }
                        _delay((unsigned long)((5000)*(12000000/4000.0)));
                        ptr_valor=0;
                        break;
                    }
                    case 'C':{
            ...
            while(PORTDbits.RD7==1 && PORTDbits.RD6==1){
                LATCbits.LATC0=1;
                _delay((unsigned long)((2)*(12000000/4000.0)));
                LATCbits.LATC0=0;
                _delay((unsigned long)((18)*(12000000/4000.0)));
                if(PORTAbits.RA0==0){
                    Lcd_Cmd(1);
                    _delay((unsigned long)((100)*(12000000/4000.0)));
                    clean_rooms();
