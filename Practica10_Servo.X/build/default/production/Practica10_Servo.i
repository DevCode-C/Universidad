...
void __attribute__((picinterrupt(("")))) timer0(void){
    if(INTCONbits.TMR0IF==1){
        if(PORTBbits.RB7==1 && PORTBbits.RB6==1 && PORTBbits.RB5==0){
            LATDbits.LATD2=1;
            ...
            LATDbits.LATD2=1;
            _delay((unsigned long)((1.5)*(12000000/4000.0)));
            LATDbits.LATD2=0;
            TMR0=39;
            INTCONbits.TMR0IF=0;
        }
